			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a
						style="margin-left: 10px; border: none"
						class="btn btn-outline-light"
						href="Controlador?menu=Productos" target="myFrame">Productos</a>
					</li>
					<li class="nav-item"><a
						style="margin-left: 10px; border: none"
					...
					<li class="nav-item">
						...
						class="btn btn-outline-light" href="Controlador?menu=Reportes&accion=default" target="myFrame">Reportes</a>
					</li>
				</ul>
			</div>
		</div>
