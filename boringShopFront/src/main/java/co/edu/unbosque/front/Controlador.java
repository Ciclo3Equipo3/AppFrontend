...
import co.edu.unbosque.front.ClientesTestJSON;
import co.edu.unbosque.front.Proveedores;
import co.edu.unbosque.front.ProveedoresTestJSON;
		...
		case "Clientes":
	    	 if (accion.equals("Listar")) {
	    		 ...
	    		 try {
	    			 ...
	    			 PrintWriter write = response.getWriter();
	    			 if (respuesta==200) {
	    				 request.getRequestDispatcher("Controller?menu=Clientes&accion=Listar").forward(request,
	                                                                               response);
	    			 } else {
	    				 write.println("Error: " +  respuesta);
	    			 }
	     ...
	     case "Proveedores":
	    	 if (accion.equals("Listar")) {
	    		 ...
	    		 try {
	    			 ...
	    			 PrintWriter write = response.getWriter();
	    			 if (respuesta==200) {
	    				 request.getRequestDispatcher("Controller?menu=Proveedores&accion=Listar").forward(request,
	                                                                               response);
	    			 } else {
	    				 write.println("Error: " +  respuesta);
	    			 }
